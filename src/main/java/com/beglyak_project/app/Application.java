package com.beglyak_project.app;

import com.beglyak_project.dao.Console;
...
public class Application {
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        while (i<10){
            PersonDaoImpl personDao = new PersonDaoImpl();
            boolean add = personDao.add(Console.getData());
            System.out.println(add);
            System.out.println();
            i++;
        }

        List<Person> personList = new PersonDaoImpl().findAll();
        for (Person person : personList) {
            System.out.println(person);
        }*/

        /*PersonDaoImpl personDao = new PersonDaoImpl();
        Person person = personDao.findId(6);
        System.out.println(person);*/

        PersonDaoImpl personDao = new PersonDaoImpl();
        Person person = new Person("Vladimir","Beglyak",29);
        System.out.println(personDao.delete(person));
